...
export const Cart = () => {
  ...
  return (
    <div>
      ...
      <div className={`absolute b-0 max-h-0 min-w-[90vw] md:min-w-[20rem] right-0 shadow-xl md:right-1 mt-10 md:mt-6 bg-white z-[2] rounded transition-all ease-in-out duration-500 opacity-0  ${openCart ? 'max-h-80 opacity-100 ' : ''}`}>
        ...
        <div className="min-h-[100px] md:min-h-[80px] flex items-center text-gray-500 font-medium">
          {number <= 0 && <div className="mx-auto"> Your cart is empty.</div>}
          {number > 0 && (
            <div className="px-4 py-6 flex flex-col gap-4">
              <div className="w-full flex justify-between items-center">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div>$125.00 x {number} <span className="font-bold text-black">${125.00 * number}</span></div>
                </div>
