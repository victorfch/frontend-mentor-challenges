export const Navbar = ({navItems, open}) => {
  return (
    <nav className={`absolute md:relative z-[1] bg-white md:bg-transparent h-screen md:h-auto top-0 left-0 pt-12 md:pt-0 w-9/12 pl-8 transition duration-500 md:duration-0 ease-in-out ${!open ? '-translate-x-full md:translate-x-0' : 'md:translate-x-0'} `}>
